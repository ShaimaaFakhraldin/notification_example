...
import 'package:notification_example/home.dart';
...
Future<void> main() async {
  ...
  await messaging.subscribeToTopic('notification_example');
  ...
  if (!kIsWeb) {
    channel = const AndroidNotificationChannel(
        'notification_example', // id
        'notification_example_title', // title
